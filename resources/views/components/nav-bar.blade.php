    ...
    <div class="flex flex-wrap justify-between items-center">
            ...
            <form action="#" method="GET" class="hidden md:block">
                ...
                <div class="relative md:w-64 md:w-96">
                    ...
                    <input type="text" name="email" id="topbar-search"
                        class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Search" />
                </div>
            </form>
        </div>
        <div class="flex items-center lg:order-2">
                ...
                <div>
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700 dark:border-neutral-700">
                    ...
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-neutral-900 rounded-full border border-white dark:border-neutral-700">
                                <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-red-600 rounded-full border border-white dark:border-neutral-700">
                                <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                    ...
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-green-400 rounded-full border border-white dark:border-neutral-700">
                                <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <div class="pl-3 w-full">
                            <div class="text-neutral-500 font-normal text-sm mb-1.5 dark:text-neutral-400">
                                <span class="font-semibold text-neutral-900 dark:text-white">Leslie Livingston</span>
                    ...
                    <a href="#" class="flex py-3 px-4 hover:bg-neutral-100 dark:hover:bg-neutral-600">
                        <div class="flex-shrink-0">
                            <img class="w-11 h-11 rounded-full"
                                src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/robert-brown.png"
                                alt="Robert image" />
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-purple-500 rounded-full border border-white dark:border-neutral-700">
                                <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <button type="button" data-dropdown-toggle="apps-dropdown"
                class="p-2 text-neutral-500 rounded-lg hover:text-neutral-900 hover:bg-neutral-100 dark:text-neutral-400 dark:hover:text-white dark:hover:bg-neutral-700 focus:ring-4 focus:ring-neutral-300 dark:focus:ring-neutral-600">
                <span class="sr-only">View notifications</span>
                <!-- Icon -->
            ...
            <!-- Dropdown menu -->
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-neutral-100 shadow-lg dark:bg-neutral-700 dark:divide-neutral-600 rounded-xl"
                id="apps-dropdown">
                <div
                    class="block py-2 px-4 text-base font-medium text-center text-neutral-700 bg-neutral-50 dark:bg-neutral-600 dark:text-neutral-300">
                    Apps
                ...
                <div class="grid grid-cols-3 gap-4 p-4">
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-600 group">
                        <svg aria-hidden="true"
                            class="mx-auto mb-1 w-7 h-7 text-neutral-400 group-hover:text-neutral-500 dark:text-neutral-400 dark:group-hover:text-neutral-400"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z"
                                clip-rule="evenodd"></path>
                        </svg>
                        <div class="text-sm text-neutral-900 dark:text-white">Sales</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-600 group">
                        <svg aria-hidden="true"
                        ...
                        <div class="text-sm text-neutral-900 dark:text-white">Users</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-600 group">
                        <svg aria-hidden="true"
                        ...
                        <div class="text-sm text-neutral-900 dark:text-white">Inbox</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-600 group">
                        <svg aria-hidden="true"
            ...
            <!-- Dropdown menu -->
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-neutral-100 shadow dark:bg-neutral-700 dark:divide-neutral-600 rounded-xl"
                id="dropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-neutral-900 dark:text-white">Neil Sims</span>
                    <span class="block text-sm text-neutral-900 truncate dark:text-white">name@flowbite.com</span>
                </div>
                ...
                <ul class="py-1 text-neutral-700 dark:text-neutral-300" aria-labelledby="dropdown">
                    <li>
                        <a href="#"
                            class="flex items-center py-2 px-4 text-sm hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white"><svg
                                class="mr-2 w-5 h-5 text-neutral-400" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"
                                    clip-rule="evenodd"></path>
                    ...
                    <li>
                        <a href="#"
                            class="flex justify-between items-center py-2 px-4 text-sm hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white">
                            ...
                            <svg aria-hidden="true" class="w-5 h-5 text-neutral-400" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
