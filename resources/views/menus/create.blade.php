<x-app-layout title="Create Restaurant">
    ...
    <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <form action="{{ route('restaurants.store') }}" method="POST" x-data="" x-on:submit="$dispatch('open-modal', 'loading-modal')">
            @csrf
